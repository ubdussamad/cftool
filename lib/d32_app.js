let params = new URLSearchParams(location.search);
  ...
  d3.json(params.get('tree'), function(treeData) {
    ...
    // // Setting up table height.
    // document.getElementById('big_container').style.height = window.innerHeight * 0.95;
    // document.getElementById('selection_table_2_div').style.height = window.innerHeight * 0.95;
    // document.getElementById('selection_table_2_div').style.display = "block";
    // // document.getElementById('selection_table_2_div').style.overflowY = "scroll";
    // document.getElementById('selection_table_2_div').style.whiteSpace = "nowrap";
    ...
    function render_graphs () {
      ...
      document.getElementById('key_reg_property_selection_ddm').onchange = function() {
        // console.log("Selected property: " + this.value);//+ this.options[this.selectedIndex].value);
        ...
        // div.insert('div').attr('id', 'graph_details_cont');

        // var table_ = document.getElementById('selection_keyreg_prop_table');
      ...
      console.log(_property_headings_list);
