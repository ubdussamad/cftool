  ...
  d3.json(params.get('tree'), function(treeData) {
    ...
    function render_graphs () {
      ...
      document.getElementById('key_reg_property_selection_ddm').onchange = function() {
        ...
        var url =  params.get('tree');
        var link_to_line_plot = "../lib/line_plotter.html?csv=" + url.slice(0, url.length -10) + '/subgraphs/prop_plots/' + name_str;

        var link_obj = document.getElementById('csv_line_plot_render');
