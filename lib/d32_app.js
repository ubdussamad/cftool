  ...
  d3.json('knowledge_tree.json', function(treeData) {
    ...
    function update(source) {
      ...
      nodeEnter.append("circle")
        ...
        .style("stroke", function(d) { return d.has_keyreg ? "rgb(113, 210, 113)" : "#ff8080" })
        .attr('id', d=> d.lineage)
        ...
        .on('dblclick', function(d) {
            current_lineage = document.getElementById('current_selection_lineage').textContent();
            d3.select(current_lineage).classed('selected_node', false);
